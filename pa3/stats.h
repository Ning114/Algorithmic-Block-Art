...
public:
	...
	vector< vector< long >> getRed();
	vector< vector< long >> getRedsq();
	vector< vector< long >> getGreen();
	vector< vector< long >> getGreensq();
	vector< vector< long >> getBlue();
	vector< vector< long >> getBluesq();
};
